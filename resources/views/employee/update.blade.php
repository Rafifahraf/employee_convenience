...
@section('container')
    <div class="card p-5">
        <h1>This Update Employee</h1>

        <form method="POST" action="/employee/{{ $data->id }}">
            @csrf
            @method('PUT')
            <div class="mb-3">
                <label for="input_name" class="form-label">Name</label>
                <input type="text" class="form-control" name="name" id="input_name" value="{{ $data->name }}"
                    maxlength="50">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="email" id="input_email" value="{{ $data->email }}"
                    maxlength="20">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="phone" id="input_phone" value="{{ $data->phone }}"
                    maxlength="13">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="address" id="input_address" value="{{ $data->address }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="salary" id="input_salary" value="{{ $data->salary }}"
                    maxlength="8">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="avatar" id="input_avatar" value="{{ $data->avatar }}">
