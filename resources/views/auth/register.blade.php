...
<head>
  ...
  <title> Register Employee Convenience</title>
            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="./index.html"  class="text-nowrap logo-img text-center d-block py-3">
                  <div>
                    <img src="{{asset('images/logos/employee_logo.png') }}" style="width: 28%" alt="">
                    <h1 class="text-info">Employee Convenience</h1>
                  </div>
                </a>

                <p class="text-center text-dark" style="font-size: 20px;">Register Here</p>
                <form action="{{url('/register')}}" method="POST">
                  ...
                  <button type="submit" class="btn btn-info w-100 py-8 fs-4 mb-4 rounded-2">Register Now</button>
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Already have an account?</p>
                    <a class="text-info fw-bold ms-2" href="/login">Sign In</a>
                  </div>
                </form>
              </div>
            </div>
